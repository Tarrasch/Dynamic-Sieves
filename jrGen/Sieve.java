...
public class Sieve extends java.lang.Object {
    { JRinit(); }
    public Op_ext.JRProxyOp JRget_op_output_intTovoid()
    {
        return op_output_intTovoid;
    }
    
    public Op_ext.JRProxyOp op_output_intTovoid;
    ...
    public Op_ext.JRProxyOp JRget_op_print_voidTovoid()
    {
        return op_print_voidTovoid;
    }
    
    public Op_ext.JRProxyOp op_print_voidTovoid;
    class ProcOp_voidTovoid_implprint extends ProcOp_ext_impl
    {
        Sieve thisarg;
        public ProcOp_voidTovoid_implprint(Sieve thisIn) throws RemoteException
        {
        thisarg = thisIn;
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                thisarg.printvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    thisarg.printvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    public void printvoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_print_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private void printvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                ...
                JRLoop1: while (true) {
                    ...
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_intTovoid = JRget_op_output_intTovoid().recv();
    ...
    public Op_ext.JRProxyOp JRget_op_nums_voidTovoid()
    {
        return op_nums_voidTovoid;
    }
    
    public Op_ext.JRProxyOp op_nums_voidTovoid;
    class ProcOp_voidTovoid_implnums extends ProcOp_ext_impl
    {
        Sieve thisarg;
        public ProcOp_voidTovoid_implnums(Sieve thisIn) throws RemoteException
        {
        thisarg = thisIn;
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                thisarg.numsvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    thisarg.numsvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    public void numsvoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_nums_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private void numsvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                // NUMBER 8
                Cap_ext_ channel = new Cap_ext_(new Op_ext_.JRProxyOp(InOp_ext_impl.create()));
                Filter f = new Filter(channel, new Cap_ext_(JRget_op_output_intTovoid()));
                JRLoop2: for (int i = 2; true; i++) {
                    channel.send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {i});
                }
            }
        } catch (Exception JRe)    {
            if (retOp != null && fretOp == null)
    ...
    protected JRSieve jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	try {
    	op_nums_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implnums(this));
    	op_print_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implprint(this));
    	op_output_intTovoid = 
    	  new Op_ext_.JRProxyOp(new InOp_ext_impl());
    	} catch (Exception JRe)
    	{ throw new jrRuntimeError(JRe.toString()); }
    	jrresref = new JRSieve(op_nums_voidTovoid, op_print_voidTovoid, op_output_intTovoid);
    	this.JRcalled = true;
    }
    ...
    private void JRprocess() {
    	...
    	JRproc = true;
    	try {
    		op_nums_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
    		op_print_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
